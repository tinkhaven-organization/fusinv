	...
	<body>
        <div id="header">
            <table>
    			...
    			<br>
                        <p>
                            <?php if ($invoice->user_name) { echo $invoice->user_name . ' ' . $invoice->user_custom_legal_form . '<br>'; } ?>
			    ...
			    <br>
                            <?php if ($invoice->user_phone) { echo $invoice->user_phone; ?><br><?php } ?>
                            <?php if ($invoice->user_fax) { ?><abbr>F:</abbr><?php echo $invoice->user_fax; ?><?php } ?>
			    <br>
                            <?php if ($invoice->user_custom_vat_number) { echo lang('tax') . ': ' . $invoice->user_custom_vat_number . '<br>'; } ?>
                            RPR: <?php if ($invoice->user_custom_rpr) { echo $invoice->user_custom_rpr . '<br>'; } ?>
                            IBAN: <?php if ($invoice->user_custom_iban) { echo $invoice->user_custom_iban . '<br>'; } ?>
                            BIC: <?php if ($invoice->user_custom_bic) { echo $invoice->user_custom_bic . '<br>'; } ?>
                        </p>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td style="padding-left: 5px;">
                        ...
                        <p><?php echo $invoice->client_name; ?><br>
                            ...
                            <?php if ($invoice->client_phone) { ?><abbr>T:</abbr><?php echo $invoice->client_phone; ?><br><?php } ?>
                            <?php if ($invoice->client_custom_vat_number) { echo lang('tax') . ': ' . $invoice->client_custom_vat_number . ' '; } ?>
                        </p>
                    </td>
                    ...
                    <td style="text-align: right;">
                        <table id="invoice-to-right-table">
                            <tbody>
                                <tr>
                                    <td><?php echo lang('invoice_number'); ?>: </td>
